...
INSERT INTO Исполнитель(id_artist, Имя_исполнителя)
VALUES
    (1,'artist_1'),
    (2,'artist_2'),
    (3,'artist_3'),
    ...
    (7,'artist_7'),
    (8,'artist_8');
INSERT INTO Альбом(id_album, Название_альбома, Год_выпуска)
VALUES
    (1,'album_1','2017'),
	(2,'album_2','2018'),
	(3,'album_3','2019'),
	...
	(7,'album_7','2017'),
	(8,'album_8','2016');
INSERT INTO Трек(id_track, Название_трека, Длительность, id_album)
VALUES
	(1,'track_1','3.05',1),
	(2,'my_track_2','3.10',2),
	(3,'track_3','3.15',3),
	...
	(15,'track_15','3.08',7),
	(16,'track_16','3.10',8);
INSERT INTO Сборник(id_collection, Название_сборника, Год_выпуска) 
VALUES
	(1,'Сборник_1','2017'),
	(2,'Сборник_2','2018'),
	(3,'Сборник_3','2019'),
	...
	(7,'Сборник_7','2020'),
	(8,'Сборник_8','2017');
INSERT INTO Жанр(id_genre, Название_жанра) 
VALUES
	(1,'genre_1'),
	(2,'genre_2'),
	(3,'genre_3'),
